...
<div class="container-fluid mt-3 mb-5">
	<div class="row">	
		<div class="col-md-8">	
			<h4 class="mb-5">Edit Pendatang</h4>
			<form action="proses_edit.php" method="post">
				...
				<div class="form-group row">
				    ...
				    <div class="col-sm-8">
				      <input type="text" name="no_kk" class="form-control form-control" id="no_kk" value="<?php echo $row['no_kk']; ?>">
				    </div>
				</div>
				...
				<div class="form-group row">
				    ...
				    <div class="col-sm-8">
				      <input type="text" class="form-control" name="asal" id="asal" value="<?php echo $row['asal']; ?>">
				    </div>
				</div>
				...
				<div class="form-group row">
				    ...
				    <div class="col-sm-8">
				      <input type="text" class="form-control" name="alamat_tujuan" id="alamat_tujuan" value="<?php echo $row['alamat_tujuan']; ?>">
				    </div>
				</div>
