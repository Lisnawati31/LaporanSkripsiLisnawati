...
<div class="container-fluid mt-3 mb-5">
	<div class="row">	
		<div class="col-md-8">	
			<h4 class="mb-5">Tambah Kematian</h4>
			<form action="proses_tambah.php" method="post">
				...
				<div class="form-group row">
				    ...
				    <div class="col-sm-8">
				      <select name="status_keluarga" class="form-control">
				      	<option selected disabled="">Pilih Status Keluagra</option>
				...
				<div class="form-group row">
				    ...
				    <div class="col-sm-8">
				      <input type="date" name="tanggal_kematian" class="form-control" id="tanggal_kematian">
				    </div>
				</div>
